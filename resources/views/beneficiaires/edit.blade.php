...
<div class="container">
    <form action="{{ route('beneficiaires.update',$beneficiaire->id) }}" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="phone" class="form-control {{ $errors->has('tel_fixe') ? 'is-invalid' : '' }}" id="tel_fixe" name="tel_fixe" placeholder="01234567" value="{{$beneficiaire->tel_fixe = '0' ? '0' : '0'.$beneficiaire->tel_fixe}}">
        ...
        <div class="mb-3">
            ...
            <input type="phone" class="form-control {{ $errors->has('tel_mobile') ? 'is-invalid' : '' }}" id="tel_mobile" name="tel_mobile" placeholder="01234567" value="{{$beneficiaire->tel_mobile = '0' ? '0' : '0'.$beneficiaire->tel_mobile}}">
