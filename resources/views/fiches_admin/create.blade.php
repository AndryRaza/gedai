...
<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('fiches_admin.create')}}">Ajouter un acte </a></li>
    </ol>
</nav>
...
<div>
    ...
    <div class="row row-cols-1" id="affichage_formulaire">
        <div class="col" id="formulaire_fiche" style="display:none">
            <form action="{{ route('fiches_admin.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
        ...
        if (document.getElementById("pdf").value != "") {
            ...
            $.ajax({
                ...
                success: function(reponse) {
                    ...
                    document.getElementById('affichage_pdf').innerHTML = ` <iframe class="w-100 h-100" src="{{asset('public/temp_pdf/`+reponse + `')}}"></iframe>`
