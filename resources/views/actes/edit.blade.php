...
<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('actes.edit',$acte->id)}}">Modifier un acte</a></li>
  </ol>
</nav>


<h1 class="text-center">Modifier un acte</h1>
...
<div class="container">
    <form action="{{ route('actes.update',$acte->id) }}" method="post">
        ...
        @method('PATCH')
        <div class="mb-3">
            <label for="nom" class="form-label">Nom de l'acte</label>
